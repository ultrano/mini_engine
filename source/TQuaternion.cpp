...
TVector3&  TQuaternion::vec() const
{
    return (TVector3&)*this;
}
...
TQuaternion& TQuaternion::rotate( const TVector3& axis, float radian )
{
...
void   TQuaternion::toEuler( TVector3& euler ) const
{
...
TQuaternion& TQuaternion::rotate( const TVector3& angle )
{
